...
>
> **继承说明**：本文继承自前作《火种》，当时基线是 C# 12 / .NET 8。文中示例的语法在 C# 14 下全部仍然有效；**C# 13 与 14 新增特性已补入**（§19、§20，`DOC-1`，2026-09-02）。示例中引用的类名来自前作代码，新代码仓建立后需替换为真实示例。
>
> **配套**：命名与风格规范以代码仓 `CONVENTIONS.md` 为准（`ENG-4`，2026-09-02 完成）。
